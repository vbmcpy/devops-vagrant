...
yum install wget unzip java-11-openjdk-devel gcc-c++ openssl-devel make nodejs -y
wget wget https://binaries.sonarsource.com/Distribution/sonarqube/sonarqube-9.1.0.47736.zip
